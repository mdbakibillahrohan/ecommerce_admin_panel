...
const handleImageUpload: UploadProps['onChange'] = (info) => {
  ...
  if (info.file.status === 'done') {
    uploadedImages.value.push(info.file.response?.url || '')
                          ...
                          <a-col :xs="24" :md="12">
                            <a-form-item label="Category" name="category_id">
                              <a-select v-model:value="formState.category_id" placeholder="Select a category"
                                size="large" show-search :filter-option="(input, option) =>
                    ...
                    <div class="card-body">
                      ...
                      <div v-if="formState.track_inventory" class="inventory-fields">
                        ...
                        <div class="stock-status">
                          <div v-if="formState.stock_quantity > formState.low_stock_threshold" class="status-good">
                            <CheckCircleOutlined />
                            Stock level is healthy
                          </div>
                          <div v-else-if="formState.stock_quantity > 0" class="status-warning">
                            <ClockCircleOutlined />
                            Low stock alert
                          </div>
