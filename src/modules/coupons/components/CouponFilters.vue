    ...
    <div class="coupon-filters">
        <div class="filter-row">
            <div class="filter-input">
                <a-input-search v-model:value="localSearchText" placeholder="Search coupons by code..." size="large"
            ...
            <div class="filter-select">
                <a-select v-model:value="localSelectedType" placeholder="All Types" size="large" allow-clear
                    ...
                    <a-select-option value="FREE_SHIPPING">Free Shipping</a-select-option>
                </a-select>
            </div>
