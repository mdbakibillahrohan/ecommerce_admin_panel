        ...
        <a-row :gutter="[16, 16]">
            <a-col :xs="24" :lg="12">
                <a-form-item label="Primary Color" name="primary_color">
                    <div class="color-picker-wrapper">
                        <input type="color" v-model="props.formState.primary_color" class="color-input" />
                        <a-input v-model:value="props.formState.primary_color" size="large" placeholder="#1890ff"
                            style="flex: 1" />
                    </div>
                </a-form-item>
            </a-col>
            ...
            <a-col :xs="24" :lg="12">
                <a-form-item label="Secondary Color" name="secondary_color">
                    <div class="color-picker-wrapper">
                        <input type="color" v-model="props.formState.secondary_color" class="color-input" />
                        <a-input v-model:value="props.formState.secondary_color" size="large" placeholder="#52c41a"
                            style="flex: 1" />
                    </div>
                </a-form-item>
            </a-col>
                ...
                <a-form-item label="Banner Image" name="banner_image">
                    <div class="image-upload-wrapper">
                        ...
                        <div v-else class="upload-preview banner-preview">
                            <a-image :width="300" :height="100"
                                :src="configuration.API_BASE_URL + bannerImage?.file_path" alt="banner"
                                class="preview-image" style="object-fit: cover" />
                            <div class="preview-actions">
                                <a-button type="primary" size="small"
                                    @click="emit('openMediaLibrary', 'banner')">Change</a-button>
